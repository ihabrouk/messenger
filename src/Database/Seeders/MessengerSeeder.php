...
class MessengerSeeder extends Seeder
{
    ...
    {
        $templateCount = \App\Messenger\Models\Template::count();
        $contactCount = \App\Messenger\Models\Contact::count();
        $messageCount = \App\Messenger\Models\Message::count();
        ...
        $activeContacts = \App\Messenger\Models\Contact::active()->count();
        $verifiedContacts = \App\Messenger\Models\Contact::verified()->count();
        $deliveredMessages = \App\Messenger\Models\Message::where('status', 'delivered')->count();
        $failedMessages = \App\Messenger\Models\Message::where('status', 'failed')->count();
