...
use App\Messenger\Drivers\AbstractProvider;
...
class MockTestDriver extends AbstractProvider implements MessageProviderInterface, ProviderDefinitionInterface
{
     ...
     */
    public function send(\App\Messenger\Data\SendMessageData $data): \App\Messenger\Data\MessageResponse
    {
        // Mock successful response
        return \App\Messenger\Data\MessageResponse::success(
            providerId: 'mocktest',
