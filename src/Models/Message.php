...
class Message extends Model
{
     ...
     */
    public function toSendData(): \App\Messenger\Data\SendMessageData
    {
        return new \App\Messenger\Data\SendMessageData(
            to: $this->to,
            body: $this->body,
            ...
            priority: $this->priority ?? \App\Messenger\Enums\MessagePriority::NORMAL,
    ...
    {
        return \App\Messenger\Database\Factories\MessageFactory::new();
    }
}
